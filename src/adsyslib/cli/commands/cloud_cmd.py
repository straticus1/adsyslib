...
from adsyslib.cloud import CloudProvider, get_cloud_provider

app = typer.Typer()
console = Console()

def get_provider(provider_type: str, profile: Optional[str] = None, region: Optional[str] = None) -> CloudProvider:
    try:
