...
def get_cloud_provider(provider_type: str, **kwargs: Any) -> CloudProvider:
    """
    ...
    if provider_type == "aws":
        return AWSProvider(region_name=kwargs.get("region"), profile_name=kwargs.get("profile"))
    elif provider_type in ("oracle", "oci"):
        return OracleProvider(
            config_file=kwargs.get("config_file"), profile=kwargs.get("profile", "DEFAULT")
        )
    else:
